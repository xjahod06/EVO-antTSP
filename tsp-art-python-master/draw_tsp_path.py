...
ORIGINAL_IMAGE = "images/darkVUTinverted-1024-stipple.png"
IMAGE_TSP = "images/darkVUTinverted-1024-stipple.tsp"
...
def draw_routes(nodes, path, FINAL_IMAGE=IMAGE_TSP.replace("-stipple.tsp","-tsp.png")):
...
def main():
    ...
    data = create_data_model(IMAGE_TSP)
